  ...
  return (
    <footer className="bg-black text-white px-6 py-10 text-sm">
      <div className="max-w-7xl mx-auto">
        {/* Top Section */}
        <div className="md:flex justify-between border-b border-gray-700 pb-8">
          {/* Newsletter */}
          <div className="md:w-1/2 mb-6 md:mb-0 flex flex-col gap-y-4.5">
            ...
            <div className="flex mt-4">
              ...
              />
              <button className="border-1 border-gray-600 text-gray-800 px-4 py-2 ml-2">SUBSCRIBE</button>
            </div>
          </div>

          {/* Contact & Currency */}
          <div className="md:w-1/2 flex flex-col gap-y-5 justify-between md:pl-10 text-gray-400">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 pt-8">
          ...
          <div>
            ...
            <ul className="space-y-1 text-white flex flex-col gap-y-2.5">
              <li>About Us</li>
              <li>Stories</li>
              <li>Artisans</li>
              <li>Boutiques</li>
